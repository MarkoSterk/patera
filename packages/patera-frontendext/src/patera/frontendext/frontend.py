...
from patera.controller import Controller, get, path
from patera import Patera, BaseExtension, Request, Response, HttpStatus
...
class _FrontendConfigs(BaseModel):
    APP_PATH: str = Field(
        "frontend_app",
        description="Relative path of the frontend application relative to the patera app",
    )
